                ...
                <div class="lg:w-1/2 xl:max-w-screen-sm">
                    <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                        <div class="cursor-pointer flex items-center">
                            <div>
                                <svg class="w-10 text-indigo-500" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 225 225">
                                    {/* <style type="text/css">
                    ...
                    <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-2 xl:px-24 xl:max-w-2xl">
                        ...
                        <div class="mt-12">
                            ...
                            <div class="mt-8 text-sm font-display font-semibold text-gray-700 text-center">
                                Have an account ?
                                <Link to='/' class="cursor-pointer text-indigo-600 hover:text-indigo-800">
                                    Log In
                                </Link>
                            </div>
