...
const Footer = () => {
  return (
    <footer class="text-center mt-10 mb-10">
      <small>
        <span className="font-poppins font-thin">© 2023 DIU</span>
        <span>&#10084;</span>

        <span className="font-poppins font-thin">All Rights Reserved.</span>
      </small>
      <br />
      <div class="flex justify-center mt-2 items-center space-x-4">
        <svg
        ...
        <svg
          className="w-7 h-7 cursor-pointer active:scale-90"
          viewBox="0 0 32 32"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
