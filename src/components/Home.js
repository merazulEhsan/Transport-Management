...
const Home = () => {
    return (
        <section> {/* <!-- Input Data --> */}
            <div class="flex justify-center shadow-sm rounded-md p-4 bg-white mb-12">
                <div class="text-center lg:max-w-3xl md:max-w-xl">
                    <h2 class="text-3xl font-bold font-poppins text-[#3f4750]">Seat Booking</h2>
                </div>
            </div>
            <div class="relative">
                <div class="bg-white rounded-md w-full mx-auto">
                    <form class="flex flex-col lg:flex-row justify-evenly items-center divide-y-2 lg:divide-y-0 lg:divide-x-2 font-poppins">
                        {/* <!-- From --> */}
                        <div class="p-5">
                            ...
                            <div class="flex flex-row items-center">
                                ...
                                <select class="outline-none px-2 py-2 w-full text-base" required>
                        ...
                        <div class="p-5">
                            <p>Date</p>
                            <input type="date" class="outline-none px-2 py-2 w-full date" required/>
                        </div>
                        ...
                        <div className='flex items-center p-5'>
                            <button type="button" class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                                <span className='flex items-center '>
                                    <svg className='w-4 h-4 font-bold' fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                    ...
                    <tbody>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 text-right">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 rounded-md bg-red-50 hover:bg-red-600 hover:text-white hover:shadow-xl cursor-pointer text-red-600 border border-red-600 p-2">
