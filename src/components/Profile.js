                ...
                <div class="w-full md:w-9/12 md:mx-2 rounded-lg">
                    ...
                    <div class="bg-white p-3 rounded-lg ">
                        ...
                        <div class="text-gray-700">
                            ...
                            <button class="block w-full text-blue-800 text-sm font-semibold rounded-lg hover:bg-gray-100 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4">Edit Information</button>
                        </div>
